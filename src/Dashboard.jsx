    ...
    >
      ...
      >
        ...
        <div className="p-3 border-top">
          ...
          <button
            onClick={handleLogout}
            className="btn btn-outline-danger w-100 d-flex align-items-center justify-content-center gap-2 fw-semibold rounded-3 py-1"
            style={{
              fontSize: "0.85rem",
            }}
          >
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  className="col-12 col-xl-6 h-100"
                  style={{
                    minHeight: 0,
                  }}
                >
