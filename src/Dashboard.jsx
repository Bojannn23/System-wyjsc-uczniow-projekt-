...
const Dashboard = () => {
  ...
  return (
    <div className={`dashboard-root d-flex flex-column ${isDarkMode ? 'dark-mode' : ''}`} style={{ height: '100vh', overflow: 'hidden', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <nav className="navbar navbar-expand border-bottom px-4 py-2" style={{ height: '64px', backgroundColor: '#ffffff', borderColor: '#f0f0f0' }}>
        <div className="container-fluid p-0">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div className="user-badge d-flex align-items-center gap-2.5 px-3 py-1.5 rounded-pill">
                    ...
                    return (
                      ...
                      >
                        <div className="d-flex justify-content-between align-items-center mb-1">
                          <h5 className="class-card-title fw-bold mb-0" style={{ fontSize: '1.05rem' }}>Klasa {cls.name}</h5>
                          {isActive && (
                        ...
                        <div className="class-card-count fw-semibold mb-1" style={{ fontSize: '0.82rem' }}>
                          {cls.studentsCount} uczniów
                        </div>
                        <div className="class-card-meta text-muted" style={{ fontSize: '0.75rem' }}>
                          • Dzisiaj: <strong>{cls.exitsToday} wyjść</strong>
                        </div>
                      </div>
                    );
                  })}
